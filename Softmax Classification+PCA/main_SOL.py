...
import utils
from utils import *
from softmax_SOL import softmaxRegression, getClassification, plotCostFunctionOverTime, computeTestError, computeTestErrorMod3, updateY
import numpy as np
...
def runSoftmaxOnMNISTMod3():
    ...
    plotCostFunctionOverTime(costFunctionHistory)
    testError = computeTestError(testX, testYmod3, theta, tempParameter)
    # Save the model parameters theta obtained from calling softmaxRegression to disk.
...
plotCostFunctionOverTime(costFunctionHistory)
testErrorPCA = computeTestError(test_pca, testY, theta, tempParameter)
print (testErrorPCA)
...
plotCostFunctionOverTime(costFunctionHistory)
testErrorCubic = computeTestError(test_cube, testY, theta, tempParameter)
print (testErrorCubic)
